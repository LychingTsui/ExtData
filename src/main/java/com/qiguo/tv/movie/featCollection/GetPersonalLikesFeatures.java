...
/**
 *修改时间:29/08/2017 
 *获得新的偏好特征   /user/tvapk/peichao/personas/userlabel/*
 *step2: 按step1（GetPersonalLikesKey）键值 提取对应特征值 
 *cutoff ＝25 梯度0.02递减
 * */ 
public class GetPersonalLikesFeatures {
	...
	InterruptedException,ClassNotFoundException{
		...
		job.setJarByClass(GetPersonalLikesFeatures.class);
