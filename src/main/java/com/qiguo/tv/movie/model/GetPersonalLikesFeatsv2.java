...
/*
 * @info: 把用户偏好分成四个梯度块，每个梯度块设为特定的特征值
 */
public class GetPersonalLikesFeatsv2 {
	public static class MapClass extends Mapper<LongWritable, Text, Text, Text>{
		...
		// 偏好梯度分块
		public double likeStep(int cutoff, int cnt){
			double sc = 0.5;
			if(cnt < cutoff){			
				if(cnt < 5){
					sc = 0.8;
	...
	InterruptedException,ClassNotFoundException{
		...
		job.setJarByClass(GetPersonalLikesFeatsv2.class);
