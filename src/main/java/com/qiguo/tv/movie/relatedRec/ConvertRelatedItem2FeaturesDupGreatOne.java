...
public class ConvertRelatedItem2FeaturesDupGreatOne {
	HashMap<String, String>movieItemsMp = new HashMap<String, String>();
	public ConvertRelatedItem2FeaturesDupGreatOne(String path)
			throws IOException{
	...
	public static void main(String[] args)throws IOException{
		...
		ConvertRelatedItem2FeaturesDupGreatOne crift = new ConvertRelatedItem2FeaturesDupGreatOne(moviePath);
