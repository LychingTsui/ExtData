...
public class ConvertRelatedItem2FeaturesFullJoinWzArea {
	HashMap<String, String>movieItemsMp = new HashMap<String, String>();
	public ConvertRelatedItem2FeaturesFullJoinWzArea(String path)
			throws IOException{
	...
	public static void main(String[] args)throws IOException{
		...
		int offset = featIdx[1] - 1; //  join起始 id
		int totlen = offset*2 - 2;   // 
		BufferedWriter bfw = new BufferedWriter(new FileWriter(outPth));
		ConvertRelatedItem2FeaturesFullJoinWzArea crift = new ConvertRelatedItem2FeaturesFullJoinWzArea(moviePath);
