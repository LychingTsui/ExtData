...
public class ConvertRelatedItem2FeaturesJoinAreaTags {
	HashMap<String, String>movieItemsMp = new HashMap<String, String>();
	public ConvertRelatedItem2FeaturesJoinAreaTags(String path)
			throws IOException{
	...
	public static void main(String[] args)throws IOException{
		...
		ConvertRelatedItem2FeaturesJoinAreaTags crift = new ConvertRelatedItem2FeaturesJoinAreaTags(moviePath);
