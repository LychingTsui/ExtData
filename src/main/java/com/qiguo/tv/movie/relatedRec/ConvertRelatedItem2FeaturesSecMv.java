...
public class ConvertRelatedItem2FeaturesSecMv {
	HashMap<String, String>movieItemsMp = new HashMap<String, String>();
	public ConvertRelatedItem2FeaturesSecMv(String path)
			throws IOException{
	...
	public static void main(String[] args)throws IOException{
		...
		ConvertRelatedItem2FeaturesSecMv crift = new ConvertRelatedItem2FeaturesSecMv(moviePath);
