...
public class ConvertRelatedItem2FeaturesSecMvJoinActDirTags {
	HashMap<String, String>movieItemsMp = new HashMap<String, String>();
	public ConvertRelatedItem2FeaturesSecMvJoinActDirTags(String path)
			throws IOException{
	...
	public static void main(String[] args)throws IOException{
		...
		ConvertRelatedItem2FeaturesSecMvJoinActDirTags crift = new ConvertRelatedItem2FeaturesSecMvJoinActDirTags(moviePath);
