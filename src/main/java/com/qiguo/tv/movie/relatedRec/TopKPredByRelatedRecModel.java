...
public class TopKPredByRelatedRecModel {
	public static class MapClass extends Mapper<LongWritable, Text, Text, NullWritable>{
		...
		private int[] featIdx = {0,0};  // featidx[0]: tags起始ID，featidx[1]:jointags 起始id
	...
	InterruptedException, ClassNotFoundException{
		...
		job.setJarByClass(TopKPredByRelatedRecModel.class);
