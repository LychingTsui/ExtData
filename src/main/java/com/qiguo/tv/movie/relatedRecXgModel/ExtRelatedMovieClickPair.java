...
import com.qiguo.tv.movie.relatedRec.ExtRelatedRecPos;
import com.qiguo.tv.movie.relatedRec.ExtRelatedRecPos.MapClass;

public class ExtRelatedMovieClickPair {
	...
	ClassNotFoundException{
		...
		Job job = Job.getInstance(conf, "clickPair");
		job.setJarByClass(ExtRelatedMovieClickPair.class);
