...
public class ZongyiRelatedDisplayUvSts {
	...
	InterruptedException,ClassNotFoundException{
		...
		Job job = Job.getInstance(conf, "zongyiRelated:uv");
		job.setJarByClass(ZongyiRelatedDisplayUvSts.class);
